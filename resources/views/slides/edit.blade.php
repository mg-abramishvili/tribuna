...
@section('content')
    ...
    <div class="px-4 py-4">
        <div class="row align-items-center mb-4">
            <div class="col-6">
                <h1>{{$slides->title}}</h1>
                <p style="color: #999">Редактирование слайда</p>
            </div>
        </div>

        <form action="/slides/{{$slides->id}}" method="post" enctype="multipart/form-data">@csrf
            @method('PUT')
            ...
            <div class="row align-items-center mb-2">
                ...
                <dd class="col-sm-9">
                    <textarea rows="7" type="text" class="form-control" name="text">{{$slides->text}}</textarea>
                </dd>
            </div>
