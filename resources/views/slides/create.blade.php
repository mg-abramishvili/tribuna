...
@section('content')
    ...
    <div class="container py-4">
        ...
        <form class="page" action="/slides" method="post" enctype="multipart/form-data">@csrf
            ...
            <div class="row align-items-center mb-2">
                ...
                <div class="row">
                    @foreach($types as $index => $type)
                        <div class="col-2">
                        <div class="radio">
                        <input name="types" id="{{ $type->id }}" type="radio" @if (!$index) {!! "checked" !!} @endif value="{{ $type->id }}">
                        <label for="{{ $type->id }}">
                            {{ $type->title }}
                        </label>
                        </div>
            ...
            <div class="row align-items-center mb-2 block-text">
                ...
                <dd class="col-sm-9">
                    <textarea rows="4" type="text" id="text" onkeyup="myFunction()" class="form-control" name="text"></textarea>
